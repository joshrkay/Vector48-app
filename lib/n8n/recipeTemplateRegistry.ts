...
export const RECIPE_WEBHOOK_PATH_PREFIX: Record<string, string> = {
  ...
  "missed-call-text-back": "recipe-2-missed-call-text-back",
  "review-request": "recipe-3-review-request",
  "estimate-follow-up": "recipe-4-estimate-follow-up",
  "appointment-reminder": "recipe-5-appointment-reminder",
};
